...
| **Título de card** — encabezados de card en /ventas, /ventas/[id], /inventario/nuevo, /inventario/[id], /servicio-tecnico y /usuarios | Archivo | 15 px en los dos anchos; con una excepción en /usuarios que se da vuelta según el ancho — ver la nota debajo de la tabla | 600 |
